...
public class PriorityQueue<TElement, TPriority> {
    ...
    static PriorityQueue() {
        UnityEngine.Debug.Log( Log2Arity > 0 && Math.Pow( 2, Log2Arity ) == Arity );
    }
#endif
    ...
    private void Grow( int minCapacity ) {
        UnityEngine.Debug.Log( _nodes.Length < minCapacity );
    ...
    private void MoveUpDefaultComparer( (TElement Element, TPriority Priority) node, int nodeIndex ) {
        ...
        UnityEngine.Debug.Log( _comparer is null );
        UnityEngine.Debug.Log( 0 <= nodeIndex && nodeIndex < _size );
    ...
    private void MoveUpCustomComparer( (TElement Element, TPriority Priority) node, int nodeIndex ) {
        ...
        UnityEngine.Debug.Log( _comparer is not null );
        UnityEngine.Debug.Log( 0 <= nodeIndex && nodeIndex < _size );
